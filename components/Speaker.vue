...
<template>
  <div class="w-[300px] items-center justify-center py-3">
    <img
      :src="
        speaker.image
          ? speaker.image
      ...
      "
      :alt="`Avatar image of ${speaker.name}`"
      srcset=""
      loading="eager"
    ...
    <p
      class="py-3 text-lg text-center text-gray-500 truncate whitespace-normal dark:text-gray-300"
    >
      {{ speaker.talk }}
    </p>
